...
class App extends Component {
  ...
  return (
    ...
    <header className="App-header">
       ...
       <div> <a className="App-a1" style ={{paddingTop:'3.5rem', paddingRight:'5rem', float:'right'}} href="#portofolio">Portfolio</a>
       <h3 className="App-h3" style={{paddingLeft:'11rem'}}  >
        Emilia Vestlund </h3></div>
  ...
  <a href="mailto:emiliavestlund@hotmail.com" className="App-apa" >emiliavestlund@hotmail.com</a>
  </div>
